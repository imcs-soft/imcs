<div id="drawer-navigation" class="fixed top-0 bottom-0 left-0 z-40 w-64 h-full pt-16 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
    ...
    <div class="pb-4 pt-2 overflow-y-auto">
        <div class="pb-5 sm:hidden">
            <div class="flex items-center">
                <div class="w-4 h-0.5 bg-gray-300 rounded-sm mr-2"></div>
                <p id="drawer-navigation-label" class="text-lg font-semibold py-2 text-gray-500 uppercase dark:text-gray-400">Paginas</p>
            </div>
            <ul class="space-y-2 font-medium px-4">
                <li>
                ...
                <li>
                    <a href="{{ route('cursos') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('fqa') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">FQA</span>
                        </a>
                </li>
            </ul>
        </div>
        ...
        <div class="pb-5">
            <div class="flex items-center">
                <div class="w-4 h-0.5 bg-gray-300 rounded-sm mr-2"></div>
                <p id="drawer-navigation-label" class="text-lg font-semibold py-2 text-gray-500 uppercase dark:text-gray-400">Panel</p>
            </div>
            <ul class="space-y-2 font-medium px-4">
                <li>
                    <a href="{{ route('mis-cursos') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="shrink-0 w-[25px] h-[26px] text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Zm4.996 2a1 1 0 0 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 8a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Zm-4.004 3a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 11a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Zm-4.004 3a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 14a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Z" clip-rule="evenodd"/>
                        </svg>
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Progreso</span>
                    </a>
                </li>
            </ul>
        </div>
