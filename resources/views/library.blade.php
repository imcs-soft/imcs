                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div class="bg-white rounded-lg shadow flex flex-col overflow-hidden">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            <h3 class="text-lg font-semibold text-gray-800">Ecografìa</h3>
                            <p class="text-sm text-gray-500">Dr. Mauricio Moreno Oleas</p>
                            <p class="text-sm text-gray-500 mb-4">pdf</p>
                            <button
                                @click="pdfUrl='https://aulaginecologia.com/wp-content/uploads/2023/10/PRINCIPIOS-DE-ECOGRAFIA.pdf#toolbar=0&navpanes=0'; open=true"
